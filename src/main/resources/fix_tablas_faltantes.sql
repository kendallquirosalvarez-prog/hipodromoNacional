-- =============================================================
-- CORRECCIÓN: tablas y procedures que faltan en Supabase
-- Módulos afectados: historial, suministros, transacciones, resultados
-- Ejecutar en Supabase › SQL Editor › New query › Run
-- =============================================================

-- historial_veterinario
DROP TABLE IF EXISTS historial_veterinario CASCADE;
...
-- resultado_carrera
DROP TABLE IF EXISTS resultado_carrera CASCADE;
...
-- alerta_veterinaria
DROP TABLE IF EXISTS alerta_veterinaria CASCADE;
CREATE TABLE alerta_veterinaria (
